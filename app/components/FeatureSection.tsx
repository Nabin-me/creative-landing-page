...
const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  <motion.div
    className="flex flex-col items-start justify-between p-6 rounded-xl relative"
  ...
  >
    ...
    <button className="text-purple-600 font-semibold hover:bg-primary/90 hover:text-white border border-gray-400 py-2 px-5 rounded-xl">
      Learn more
    </button>
    <motion.div
      className="absolute inset-0 bg-purple-100 rounded-xl -z-10 scale-105"
